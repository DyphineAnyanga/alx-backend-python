...
class ViewSetMixin:
    ...
    def as_view(cls, actions=None, **initkwargs):
        ...
        # The suffix init kwarg is reserved for displaying the viewset type.
        # This init kwarg should have no effect if the name is provided.
        # eg. 'List' or 'Instance'.
        cls.suffix = None

        # The detail initkwargs is reserved for introspecting the viewset type.
        cls.detail = None
